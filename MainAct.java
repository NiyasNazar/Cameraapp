package com.admin.innostack.cameraapp.Payment;
...
import com.admin.innostack.cameraapp.R;
...
public class MainAct extends BaseActivity implements View.OnClickListener {
    ...
    private void setupCitrusConfigs() {
        ...
        if (appEnvironment == AppEnvironment.PRODUCTION) {
            Toast.makeText(MainAct.this, "Environment Set to Production", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(MainAct.this, "Environment Set to SandBox", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    //  generateHashFromServer(mPaymentParams);
          ...
          mPaymentParams = calculateServerSideHashAndInitiatePayment1(mPaymentParams);
           if (AppPreference.selectedTheme != -1) {
                PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams,MainAct.this, AppPreference.selectedTheme,mAppPreference.isOverrideResultScreen());
            } else {
                PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams,MainAct.this, R.style.AppTheme_default, mAppPreference.isOverrideResultScreen());
            }

        } catch (Exception e) {
            // some exception occurred
            Toast.makeText(this, "some"+e.getMessage(), Toast.LENGTH_LONG).show();
            payNowButton.setEnabled(true);
        }
    }
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(MainAct.this);
...
//https://payu.herokuapp.com/get_hash
            //https://dipindkumar.000webhostapp.com/getHashCode
            String merchantHash = "";
            Log.i("ttid",ttid);
            try {
                //TODO Below url is just for testing purpose, merchant needs to replace this with their server side hash generation url
                URL url = new URL("https://dipindkumar.000webhostapp.com/get_hash_data.php?");
                ...
                while (payuHashIterator.hasNext()) {
                  ...
                  merchantHash = response.getString(key);
                          // merchantHash="46c703d632dbb44b4d2f9c738603124b0febd60f81672b1b8d6deb7c614db029efc767acb0c65a29b4acdedbb5f199b7079f3e4f6d9cb6e5e61b014ba5f4f8d1";
                            Log.i("testhash",merchantHash);
                            break;
                        default:
                            break;
                    }
        ...
        protected void onPostExecute(String merchantHash) {
          ...
          //  merchantHash="46c703d632dbb44b4d2f9c738603124b0febd60f81672b1b8d6deb7c614db029efc767acb0c65a29b4acdedbb5f199b7079f3e4f6d9cb6e5e61b014ba5f4f8d1";
            ...
            if (merchantHash.isEmpty() || merchantHash.equals("")) {
                Toast.makeText(MainAct.this, "Could not generate hash", Toast.LENGTH_SHORT).show();
            } else {
